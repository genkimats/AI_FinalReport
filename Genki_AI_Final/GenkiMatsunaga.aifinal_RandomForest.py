...
def load_data(folder_path):
    """
    Load data from the processed abstracts files in the specified folder.

    Args:
        folder_path (string): Path to the folder containing the processed abstracts.
...
# Load abstracts data
folder_path = "abstracts_processed"
